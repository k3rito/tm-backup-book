...
class TransferService:
    ...
    async def _flush_completed(self, force: bool = False) -> None:
        ...
        # Batch the R2 and local state persistence outside the loop to achieve O(1) complexity per flush.
        # This significantly reduces R2 network calls and local I/O when processing multiple sequential completions.
