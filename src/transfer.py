...
class TransferService:
    ...
    async def _flush_completed(self, force: bool = False) -> None:
        ...
        # Optimization: Batch progress persistence outside the loop to execute once per flush
        # instead of making N network calls to R2 and local disk I/O operations per outcome.
