...
class TransferService:
    ...
    async def _flush_completed(self, force: bool = False) -> None:
        # Optimization: Move progress persistence outside the loop to reduce updates from O(N) to O(1).
        # This batches state updates to prevent redundant local I/O and R2 uploads for consecutive messages,
        # dramatically reducing network latency and operations under load.
        advanced = False
        while True:
