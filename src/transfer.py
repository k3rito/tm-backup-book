...
class TransferService:
    ...
    async def _flush_completed(self, force: bool = False) -> None:
        ...
        # Bolt Optimization: Batch state persistence outside the flush loop to achieve O(1) network calls
        # and disk I/O per batch flush instead of O(N) calls on every completed outcome.
