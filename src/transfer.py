...
class TransferService:
    ...
    async def run(self) -> None:
        ...
        # Bolt ⚡ Optimization: Retrieve current RSS bytes once and reuse for both byte and MB representations
    ...
    async def _emit_summary(self) -> None:
        ...
        self._logger.info(
            ...
            extra={
                ...
                # Bolt ⚡ Optimization: Reuse `snapshot.rss_bytes` and `snapshot.rss_mb` to avoid calling `current_rss_bytes()`
                "rss_bytes": snapshot.rss_bytes,
                "rss_mb": snapshot.rss_mb,
            },
        )
