...
class TransferService:
    ...
    async def _flush_completed(self, force: bool = False) -> None:
        ...
        # ⚡ Bolt Optimization: Batch progress state persistence outside the flush loop.
        # This reduces local I/O and R2 API network calls from O(N) to O(1) per flush operation.
