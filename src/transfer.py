...
class TransferService:
    ...
    async def _flush_completed(self, force: bool = False) -> None:
        ...
        # Performance optimization (Bolt ⚡): Persist progress state once after flushing all
        # ready completed outcomes instead of making an R2 network call & local I/O for every
        # individual message. Reduces I/O operations from O(N) to O(1) per flush batch.
