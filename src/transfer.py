...
class TransferService:
    ...
    async def _flush_completed(self, force: bool = False) -> None:
        ...
        # Batch the persistence of progress state to storage.
        # Calling this outside the loop reduces R2/local I/O from O(N) to O(1) per flush cycle,
        # which provides a significant speedup during high-throughput or catch-up phases.
