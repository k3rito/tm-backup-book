...
class TransferService:
    ...
    async def _flush_completed(self, force: bool = False) -> None:
        ...
        # Bolt ⚡ Optimization: Persist progress state only once per flush
        # instead of on every iteration. This turns O(N) network and file I/O operations
        # bottleneck into O(1) complexity, substantially reducing latency and API usage.
