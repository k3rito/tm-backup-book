...
class TransferService:
    ...
    async def run(self) -> None:
        ...
        # Bolt Optimization: Fetch the RSS once and reuse the value for both byte and mb calculations to minimize utility call overhead.
    ...
    async def _flush_completed(self, force: bool = False) -> None:
        ...
        # Bolt Optimization: Avoid O(N) network calls and local I/O inside the loop.
        # Batch persisting progress state to R2 and local disk exactly once per flush.
