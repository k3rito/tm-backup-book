...
class TransferService:
    ...
    async def _flush_completed(self, force: bool = False) -> None:
        ...
        # Performance optimization: Persist progress state once after processing all completed
        # items in the flush batch, avoiding O(N) network calls to R2 and disk I/O per batch.
