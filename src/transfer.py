...
class TransferService:
    ...
    async def _flush_completed(self, force: bool = False) -> None:
        ...
        # Batch progress persistence: Only write to local file and sync to Cloudflare R2
        # once per flush operation instead of repeatedly within the loop (moving from O(N) to O(1)).
