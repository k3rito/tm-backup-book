...
class TransferService:
    ...
    async def _flush_completed(self, force: bool = False) -> None:
        ...
        # Batch progress persistence: Only save progress once per flush loop instead of on every iteration.
        # This reduces network I/O to Cloudflare R2 from O(N) to O(1) per flush, speeding up batch updates significantly.
