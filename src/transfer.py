    ...
    async def _flush_completed(self, force: bool = False) -> None:
        ...
        while True:
            if self._next_commit_id in self._completed_outcomes:
                ...
                # Performance: _persist_progress_state is called once at the end of _flush_completed
                # instead of inside the loop to avoid redundant local I/O and R2 network calls.
