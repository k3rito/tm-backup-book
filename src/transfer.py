...
class TransferService:
    ...
    async def _flush_completed(self, force: bool = False) -> None:
        ...
        # Bolt ⚡ Optimization: Batch progress persistence to avoid O(N) disk/R2 writes.
        # Calling _persist_progress_state() on every iteration inside the while loop is highly redundant.
        # Batching it outside the loop after all sequential commits have been processed ensures O(1) complexity.
