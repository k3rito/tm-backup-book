...
class TransferService:
    ...
    async def run(self) -> None:
        ...
        # Bolt Optimization: Query RSS bytes once and reuse for both metrics to reduce utility overhead.
    ...
    async def _flush_completed(self, force: bool = False) -> None:
        ...
        # Bolt Optimization: Persist state only once after resolving all completed message IDs to shift from O(N) to O(1) network/disk operations.
