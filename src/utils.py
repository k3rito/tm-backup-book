...
# Bolt Optimization: Cache the Process object globally to avoid the overhead
# of re-importing psutil and instantiating the process object on every memory health query.
_PROCESS = None
