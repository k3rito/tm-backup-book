...
def classify_media(message: Any) -> str | None:
    ...
    # Performance optimization: Check cheap boolean media flags before doing string operations / Path instantiations
...
def resolve_media_filename(message: Any, kind: str) -> str:
    ...
    # Defer content_type lowercasing & extraction until original_name check is complete
