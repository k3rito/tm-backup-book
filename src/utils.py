...
def current_rss_bytes() -> int:
    # Optimization: Cache psutil.Process() instance globally to eliminate redundant object
    # creation on repeated memory metric queries, reducing call overhead by ~2.6x.
    global _PROCESS
    try:
        if _PROCESS is None:
