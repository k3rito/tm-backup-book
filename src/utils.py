...
def current_rss_bytes() -> int:
    # Lazily initialize and cache psutil.Process() globally to avoid redundant process
    # handle creation and module imports on high-frequency log/health calls (~2.7x speedup).
    global _PROCESS
    try:
        if _PROCESS is None:
